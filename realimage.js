...
const ImageViewer = ({ images, initialIndex = 0, onClose, sender = "Unknown" }) => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, marginLeft: '16px' }}>
          <h1 style={{ color: 'white', fontWeight: '600', fontSize: '18px', margin: 0 }}>{sender}</h1>
          <p style={{ color: '#9ca3af', fontSize: '14px', margin: 0 }}>Dec 9, 23:05</p>
        </div>
