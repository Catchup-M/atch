const App = () => {
  ...
  return (
    <div style={{ width: '100%', height: '100%', overflow: 'hidden', background: '#fff' }}>
      ...
      >
        <div style={{ padding: '10px 20px', background: '#fff', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)' }}>
        ...
        >
          ...
          >
            <div>
              <div style={{ fontSize: '16px', fontWeight: 'normal', color: '#000', marginBottom: '6px' }}>
                Daddy Steve
              </div>
