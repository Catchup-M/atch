...
const [messages, setMessages] = useState([
  ...
  return (
    <div style={{ width: '100%', height: '100%', overflow: 'hidden', background: '#fff' }}>
      ...
      >
        <div style={{ padding: '10px 20px', background: '#fff', boxShadow: '0 2px 4px -1px rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)' }}>
        ...
        >
          ...
          >
            <div>
              <div style={{ fontSize: '16px', fontWeight: 'normal', color: '#000', marginBottom: '4px' }}>
                Daddy Steve
              </div>
