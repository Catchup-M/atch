...
const App = () => {
  ...
  const [imageViewerData, setImageViewerData] = useState({ images: [], initialIndex: 0, sender: '' });

  const openChat = () => setShowChat(true);
  const closeChat = () => setShowChat(false);

  const openImageViewer = (images, initialIndex, sender) => {
    setImageViewerData({ images, initialIndex, sender });
        ...
        <nav style={{
          ...
          <div style={{
            ...
            onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
              <svg
                style={{ width: '24px', height: '24px', stroke: '#374151', strokeWidth: '2', fill: 'none' }}
