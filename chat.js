const ChatView = ({
  ...
  // Update input bar height dynamically with ResizeObserver
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      <div
        ...
        style={{
          padding: '70px 18px',
          paddingBottom: showEmojiPicker ? `${inputBarHeight + 300}px` : `${inputBarHeight}px`,
          flex: 1,
          overflowY: 'auto',
      ...
      {showScrollButton && (
        <button
          ...
          style={{
            position: 'fixed',
            right: '16px',
            bottom: showEmojiPicker ? `${inputBarHeight + 300}px` : `${inputBarHeight}px`,
            width: '40px',
            height: '40px',
            borderRadius: '50%',
            background: '#fff',
