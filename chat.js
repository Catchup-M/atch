const ChatView = ({
  ...
  const openImageViewer = (imageUrl, messageDate, isSent) => {
    ...
    setImageViewerState({
      ...
      messageDate: messageDate || 'Unknown Date',
      senderName: isSent ? 'You' : 'Daddy Steve'
    });
  };
  ...
  return (
    <div style={{
      ...
      {imageViewerState && typeof window.ImageViewer !== 'undefined' && (
        React.createElement(window.ImageViewer, {
          images: imageViewerState.images,
          initialIndex: imageViewerState.initialIndex,
          onClose: closeImageViewer,
          senderName: imageViewerState.senderName,
          messageDate: imageViewerState.messageDate
        })
      )}
    </div>
  );
