const ChatView = ({
  ...
  useEffect(() => {
    setReplyBarHeight(replyingTo ? 58 : 0); // Approximate height of reply bar
  }, [replyingTo]);
  ...
  return (
    <div style={{
      ...
      <div
        ...
        style={{
          padding: '70px 18px',
          paddingBottom: showEmojiPicker ? '370px' : `${totalInputAreaHeight + 12}px`,
          flex: 1,
          overflowY: 'auto',
      ...
      {showScrollButton && (
        <button
          ...
          style={{
            position: 'fixed',
            right: '16px',
            bottom: showEmojiPicker ? '375px' : `${totalInputAreaHeight + 12}px`,
            width: '40px',
            height: '40px',
            borderRadius: '50%',
            background: '#fff',
